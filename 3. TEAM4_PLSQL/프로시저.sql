...
BEGIN
    ...
    EXCEPTION
        ...
        WHEN OTHERS
            THEN ROLLBACK;
END;
--==>> Procedure PRC_TC_DELETE이(가) 컴파일되었습니다.
...
BEGIN
    ...
    COMMIT;
END;
--==>> Procedure PRC_SUB_OPEN_UPDATE이(가) 컴파일되었습니다.
...
BEGIN
    ...
    COMMIT;
END;
--==>> Procedure PRC_CLASSROOM_DLETE이(가) 컴파일되었습니다.
...
BEGIN
    ...
    COMMIT;
END;
--==>> Procedure PRC_SUB_OP_SELECT이(가) 컴파일되었습니다.
...
BEGIN
    ...
    COMMIT;
END;
--==>> Procedure PRC_STD_INSERT이(가) 컴파일되었습니다.
...
BEGIN     
    ...
    COMMIT;
END;
--==>> Procedure PRC_STU_REG_MANEDIT이(가) 컴파일되었습니다.
...
BEGIN
    ...
    COMMIT;
END;
--==>> Procedure PRC_DR_STD_INSERT이(가) 컴파일되었습니다.
...
BEGIN
    ...
    COMMIT;
END;
--==>> Procedure PRC_DR_RE_UPDATE이(가) 컴파일되었습니다.
...
BEGIN
    ...
    COMMIT;
END;
--==>> Procedure PRC_DR_STD_UPDATE이(가) 컴파일되었습니다.
...
-- 중도탈락학생이라면 중도탈락코드 삭제
    ...
    COMMIT;
END;
--==>> Procedure PRC_DR_STD_DELETE이(가) 컴파일되었습니다.
...
BEGIN
    ...
    COMMIT;
END;
--==>> Procedure TEACHER_REGISTER_TC_UPDATE이(가) 컴파일되었습니다.
...
BEGIN
    ...
    EXCEPTION
       WHEN USER_DEFINE_ERROR
            ...
            ROLLBACK;
END;
--==>> Procedure PRC_TC_PW_CHANGE이(가) 컴파일되었습니다.
...
BEGIN
    ...
    EXCEPTION
        ...
        WHEN OTHERS
            THEN ROLLBACK;
END;
--==>> Procedure PRC_IN_SCR_INSERT이(가) 컴파일되었습니다.
...
BEGIN
    ...
    COMMIT;
END;
--==>> Procedure PRC_OP_SUB_UPDATE_RATE이(가) 컴파일되었습니다.
...
BEGIN
    ...
    EXCEPTION
        ...
        WHEN OTHERS
            THEN ROLLBACK;
END;
--==>> Procedure PRC_PRINT_SUBJECT_GRADE이(가) 컴파일되었습니다.
...
END;
--==>> Procedure PRC_GRADE_CURSOR이(가) 컴파일되었습니다.
...
BEGIN
    ...
    EXCEPTION
        ...
        WHEN OTHERS
            THEN ROLLBACK;
END;
--==>> Procedure PRC_IN_SCR_DELETE이(가) 컴파일되었습니다.
...
BEGIN
    ...
    COMMIT;    
END;
--==>> Procedure PRC_IN_SCR_UPDATE이(가) 컴파일되었습니다.
...
BEGIN
    ...
    COMMIT;
END;
--==>> Procedure PRC_IN_SCR_UPDATE2이(가) 컴파일되었습니다.
...
BEGIN
    ...
    EXCEPTION
       WHEN USER_DEFINE_ERROR
            ...
            ROLLBACK;
END;
--==>> Procedure PRC_STD_PW_CHANGE이(가) 컴파일되었습니다.
...
BEGIN
    ...
    COMMIT;
END;
--==>> Procedure PRC_STU_REG_STUEDIT이(가) 컴파일되었습니다.
...
END;
--==>> Procedure PRC_GET_SUBJECT_LIST이(가) 컴파일되었습니다.
...
END;
--==>> Procedure PRC_GET_STUDENT_GRADE이(가) 컴파일되었습니다.
...
END;
--==>> Procedure PRC_PRINT_STUDENT_GRADE이(가) 컴파일되었습니다.